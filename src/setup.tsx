...
import { Dashboard as DashboardLayout, DashboardNarrow as DashboardNarrowLayout, DEFAULT_PROPS_PROVIDER, MUI_DATE_LOCALIZATION_PROVIDER } from '@sienar/react-ui-mui';
...
export default function setup() {
	...
	// Providers
	registerProvider(inject(DEFAULT_PROPS_PROVIDER));
